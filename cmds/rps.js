            ...
            if (userData === undefined || userData.balance === 0) {
                ...
                if (bananaBet > userData.balance) {
                    ...
                    if (currentlyPlaying.has(message.author.id)) {
                        return {
                            status: true,
                            message: ":x: It seems like you already have an ongoing rock paper scissors game.",
                        };
                    }
                        ...
                        msg.react("✌️").then(r => {
                            msg.react("✋").then(r => {
                                ...
                                function victory() {
                                    ...
                                    msg.edit({
                                        "embed": {
                                            "description": `**You win! The monkey busted!**\nYou won **${bananaBet}** bananas. You now have **${bananaData[message.author.id].balance}**.`,
                                            "author": {
                                                "name": `${message.member.displayName}'s Rock Paper Scissors`
                                            },
                                            "thumbnail": {
                                ...
                                function defeat() {
                                    ...
                                    msg.edit({
                                        "embed": {
                                            "description": `**You lose! Busted!** You lost **${bananaBet}** bananas. You now have **${bananaData[message.author.id].balance}**.`,
                                            "author": {
                                                "name": `${message.member.displayName}'s Rock Paper Scissors`
                                            },
                                            "thumbnail": {
                                ...
                                function afk() {
                                    msg.edit({
                                        "embed": {
                                            "description": "**Timeout!** User was unable to react within 60 seconds.",
                                            "author": {
                                                "name": `${message.member.displayName}'s Rock Paper Scissors`
                                            },
                                            "thumbnail": {
